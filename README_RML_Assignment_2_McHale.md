# Responsible Machine Learning - COMPAS Recidivism Analysis - Explainability Audit (Homework 2) - William McHale

## Purpose

This repository contains the explainability audit of the logistic regression
model built in `CODE_RML_Assignment_1_MCHALE_2026.03.29.ipynb` (Homework 1). The
...
3. **Open the HW2 notebook**
   ```
   jupyter notebook HW2_COMPAS_Explainability_HW2_McHale_2026_03_29.ipynb
   ```
